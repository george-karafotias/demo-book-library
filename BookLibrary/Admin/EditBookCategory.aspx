<%@ Page Title="Edit Category" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditBookCategory.aspx.cs" Inherits="BookLibrary.Admin.EditBookCategory" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="UpdateBookCategoryButton_Click" Text="Update" CssClass="btn btn-default" />
            </div>
        </div>
    </div>
</asp:Content>
