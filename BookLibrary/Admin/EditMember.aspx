<%@ Page Title="Edit Member" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditMember.aspx.cs" Inherits="BookLibrary.Admin.EditMember" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="UpdateMemberButton_Click" Text="Save" CssClass="btn btn-default" />
            </div>
        </div>
    </div>
</asp:Content>
