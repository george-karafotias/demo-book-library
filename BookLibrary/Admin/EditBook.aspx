<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditBook.aspx.cs" Inherits="BookLibrary.Admin.EditBook" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="UpdateBookButton_Click" Text="Update" CssClass="btn btn-default" />
            </div>
        </div>
    </div>
</asp:Content>
